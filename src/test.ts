...
const run = async () => {
  ...
  console.log('states 1', wsp1.awareness.getStates());
  console.log('states 2', wsp2.awareness.getStates());

  wsp1.awareness.setLocalStateField('foo', 1);
  await wait(0.3);
  console.log('states 1 - initialized to foo:1');
  console.log('states 1', wsp1.awareness.getStates());
  console.log('states 2', wsp2.awareness.getStates());

  wsp2.awareness.setLocalStateField('foo', 2);
  await wait(0.3);
  console.log('states 2 - initialized to foo:2');
  console.log('states 1', wsp1.awareness.getStates());
  console.log('states 2', wsp2.awareness.getStates());

  wsp1.awareness.setLocalStateField('foo', 4);
  await wait(0.3);
  console.log('states 1 - changed to foo:4');
  console.log('states 1', wsp1.awareness.getStates());
  console.log('states 2', wsp2.awareness.getStates());

  wsp2.awareness.setLocalStateField('foo', 3);
  await wait(0.3);
  console.log('states 2 - changed to foo:3');
  console.log('states 1', wsp1.awareness.getStates());
  console.log('states 2', wsp2.awareness.getStates());
